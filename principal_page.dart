...
import 'package:assistente_vacinacao/pages/agendamento_page_pt1.dart';
...
class _PrincipalPageState extends State<PrincipalPage> {
  ...
  String? verificaAgendamento2(Cidadao cidadao) {
    if (cidadao.temAgendamento)
      return 'Nome da Unidade de Saúde: ${cidadao.agendamento.posto.nome}\n' +
          'Localização: ${cidadao.agendamento.posto.endereco}';
    else
